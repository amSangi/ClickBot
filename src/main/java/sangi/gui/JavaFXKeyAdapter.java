...
public class JavaFXKeyAdapter implements NativeKeyListener{
    ...
    private KeyEvent getJavaFXKeyEvent(NativeKeyEvent nativeKeyEvent, EventType<KeyEvent> eventType){
        ...
        if (eventType.equals(KeyEvent.KEY_PRESSED) || eventType.equals(KeyEvent.KEY_RELEASED)){
